<template>
  <div class="keranjang">
    <NavbarWorld :updateKeranjang="keranjangs" />
    <div class="container">
      <div class="row mt-4">
        <div class="col">
              ...
              <tbody>
                ...
                >
                  ...
                  <td>
                    <img
                      :src="
                        require('../assets/image/' + keranjang.products.gambar)
                      "
  ...
  methods: {
    ...
    checkout() {
      if (this.pesan.nama && this.pesan.noMeja) {
        // semua keranjangnya nanti masuk kedalam pesan dan disimpan di dalam keranjang
        ...
        axios
          ...
          .then(() => {
            ...
            this.$router.push({ path: "/pesanan-masuk" });
        ...
        this.$toast.error("harap diisi form", {
          type: "error",
          position: "top-right",
          duration: 3000,
          dismissible: true,
